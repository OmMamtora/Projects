...
<head>
    ...
    <link rel="stylesheet" href="h_complain.css">
</head>
<body>
</body>
</html>
...
<?php
    ...
    $sql = "SELECT * FROM hardware_requirement";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>";
                ...
                echo "<input type='hidden' name='entry_id' value='" . $row['hardware_id'] . "'>";
        ...
        echo "<p class='no-data-message'>No data found in the table.</p>";
    }
