...
<form id="mseFormPra" method="post">
  <div class="container">
    <span class="msg">MSE Practical Registration</span>
  ...
  <div class="buttons">
    <div class="add_btn">
      <button type="submit" id="addButton" name="add_data" formaction="MSE_practical_data.php"> + Add</button>
    </div>
...
<script>
  ...
  function resetForm() {
    document.getElementById("mseFormPra").reset();
  }
</script>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql1 = "INSERT INTO mse_practical (name,email,enrollment_no,branch,semester,subject) VALUES (?,?,?,?,?,?)";
